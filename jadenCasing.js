/*
	...
	'expected to be in the example below. Your task is to convert strings to how they would be written by Jaden Smith. ' +
...
String.prototype.toJadenCase = function () {
	return this.toString().split(" ").map(word => word[0] === word[0].toUpperCase() ? word : word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
};
